	...
	private function proceedAction($actionId, $arActionArguments = null)
	{
		...
		switch ($actionId)
		{
			...
			case self::ACTION_COMPLETE:
				...
				$isCreatorDirector = \Bitrix\Tasks\Util\User::isBoss($arTaskData['CREATED_BY'], $this->executiveUserId);
	...
	private static function getBaseAllowedActions()
	{
		...
		if ($arBaseActionsMap === null)
		{
			$arBaseActionsMap = array(
				...
				MY_TASKS_STATUS_ASSESSMENT => array( //Права на операции с задачей в статусе ASSESSMENT
					self::ROLE_DIRECTOR => array(
						self::ACTION_EDIT,
						self::ACTION_REMOVE,
						self::ACTION_DISAPPROVE
